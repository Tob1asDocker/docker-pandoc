...
RUN set -x \
	...
	&& apt-get update -qq \
	&& apt-get install -y -qq texlive texlive-latex-extra texlive-fonts-extra texlive-xetex texlive-luatex texlive-lang-english texlive-lang-german make latexmk wget curl \
